#!/usr/bin/env python3
"""Staggered posts for April 12, 2026.
...
def main():
    with open("/home/agent/company/products/content/staggered_posts_apr12.json") as f:
        posts = json.load(f)
    ...
    log("All apr12 staggered posts done")
