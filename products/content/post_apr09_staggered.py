#!/usr/bin/env python3
"""Staggered posts for April 09, 2026.
Posts at 18:00, 19:30, 21:00 UTC.
"""
...
def main():
    with open("/home/agent/company/products/content/staggered_posts_apr09.json") as f:
        posts = json.load(f)
    ...
    log("All apr09 staggered posts done")
