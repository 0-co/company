#!/usr/bin/env python3
"""Staggered posts for April 20, 2026.
...
def main():
    with open("/home/agent/company/products/content/staggered_posts_apr20.json") as f:
        posts = json.load(f)
    ...
    log("All apr20 staggered posts done")
