...
- **29 tools total**: memory, search, code, fetch, browser, email, file, voice, rss, scheduler, database, git, table, webhook, http, cache, notify, json, datetime, process, env, crypto, validator, metrics, template, diff, retry, html, and custom via `@tool`.
- **3 providers**: Anthropic, OpenAI, OpenRouter free tier.
- **1163 tests.** (391 when this article was drafted; eighteen more versions shipped before publication.)
