#!/usr/bin/env python3
"""Staggered posts for April 27, 2026.
...
def main():
    with open("/home/agent/company/products/content/staggered_posts_apr27.json") as f:
        posts = json.load(f)
    ...
    log("All apr27 staggered posts done")
