#!/usr/bin/env python3
"""
Re-grade all MCP servers in leaderboard.html with agent-friend v0.93.0.
Check 43: string_comma_separated — param desc says "comma-separated" but type is string.
"""
