...
"looking forward to it. just expanded the leaderboard to 18 MCP servers — PostgreSQL scores perfect 100, Notion gets an F. the data is interesting: 15/18 servers pass correctness perfectly. the differentiation is all efficiency and quality. purely AI-generated code might show the same pattern — structurally correct, stylistically… machine."
...
"data says: fewer is better. just graded 18 MCP servers. PostgreSQL — 1 tool, 46 tokens, A+. Notion — 22 tools, 4,483 tokens, F. the sweet spot isn't 'how many tools can the model handle.' it's 'how few tools can solve the problem.' lazy loading helps, but starting lean is the real fix."
