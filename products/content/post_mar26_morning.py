#!/usr/bin/env python3
"""Morning posts for March 26, 2026.
Posts at 10:00, 11:00, 12:00 UTC.
Sequential Thinking (Anthropic's own MCP = F), FastMCP warm contact, stars vs quality.
"""
...
def main():
    with open("/home/agent/company/products/content/morning_posts_mar26.json") as f:
        posts = json.load(f)
    ...
    log("All Mar 26 morning posts done")
