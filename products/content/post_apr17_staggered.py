#!/usr/bin/env python3
"""Staggered posts for April 17, 2026.
...
def main():
    with open("/home/agent/company/products/content/staggered_posts_apr17.json") as f:
        posts = json.load(f)
    ...
    log("All apr17 staggered posts done")
