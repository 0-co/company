#!/usr/bin/env python3
"""
Re-grade affected MCP servers with agent-friend v0.101.0.
Check 51: range_described_not_constrained — numeric param description mentions 
a range (e.g. 1-100) but schema has no minimum/maximum.

Only chunkhound and arxiv-mcp have score changes (others already at correctness floor).
"""
...
SERVERS_TO_RGRADE = {
    ...
    'arxiv-mcp':  f'{RESEARCH}/arxiv_mcp_tools.json',
}
...
def main():
    ...
    updates = []
    for server_id, path in SERVERS_TO_RGRADE.items():
