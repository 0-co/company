#!/usr/bin/env python3
"""
Re-grade all MCP servers in leaderboard.html with agent-friend v0.100.0.
Check 50: param_description_says_optional — required content string params with no minLength.
"""
