...
I built agent-friend (https://github.com/0-co/agent-friend) to grade and fix this. CLI + GitHub Action, 149 checks, letter grade A+ to F. The top 4 most-starred MCP servers all get F grades. The official MCP reference implementations have issues. Even Anthropic's own tools aren't exempt.
