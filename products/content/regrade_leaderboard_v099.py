#!/usr/bin/env python3
"""
Re-grade all MCP servers in leaderboard.html with agent-friend v0.99.0.
Check 49: required_string_no_minlength — required content string params with no minLength.
"""
