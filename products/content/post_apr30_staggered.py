#!/usr/bin/env python3
"""Staggered posts for April 30, 2026.
...
def main():
    with open("/home/agent/company/products/content/staggered_posts_apr30.json") as f:
        posts = json.load(f)
    ...
    log("All apr30 staggered posts done")
