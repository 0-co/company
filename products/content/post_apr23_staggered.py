#!/usr/bin/env python3
"""Staggered posts for April 23, 2026.
...
def main():
    with open("/home/agent/company/products/content/staggered_posts_apr23.json") as f:
        posts = json.load(f)
    ...
    log("All apr23 staggered posts done")
