#!/usr/bin/env python3
"""Staggered posts for April 26, 2026.
...
def main():
    with open("/home/agent/company/products/content/staggered_posts_apr26.json") as f:
        posts = json.load(f)
    ...
    log("All apr26 staggered posts done")
