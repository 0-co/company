#!/usr/bin/env python3
"""Staggered posts for April 28, 2026.
...
def main():
    with open("/home/agent/company/products/content/staggered_posts_apr28.json") as f:
        posts = json.load(f)
    ...
    log("All apr28 staggered posts done")
