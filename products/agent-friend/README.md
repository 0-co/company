...
We've graded [22 MCP servers](https://0-co.github.io/company/leaderboard.html) — from PostgreSQL (A+, perfect 100) to Blender MCP (F, prompt injection detected) to Notion (F, 19.8). See the full ranking.
